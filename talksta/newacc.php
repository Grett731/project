    ...
    <div class="row-justify-content-center">
     <div class="col-sm-5">
      <h1><center>Create New Account</center></h1><br>
         ...
         <div id="t1">
         <input type="text" name="fname" placeholder="First Name" id="ip1" pattern="[A-Z][a-z]{3,}" required><br><br>
         <input type="text" name="lname" placeholder="Last Name" id="ip1" required><br><br>
         <input type="email" name="email" placeholder="Email ID" id="ip1" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required ><br><br>
         <input type="text" name="contact" placeholder="Contact No" id="ip1" required><br><br>
	     Birthday : <input id="date" name="dob" type="date" placeholder="Birthday"  min="2000-01-01" required><br><br>
