...
<div class="container" >
 ...
 <center>
  <img src="<?php echo $row['profile_pic']; ?>" class="img-circle" width="100px" height="100px">
   ...
   <?php
   $result2 = mysqli_query($con,"SELECT * FROM skills WHERE user='$_SESSION[email]' ") or die('Could not connect: ' . mysqli_error($con));
   ...
   <?php
   $result3 = mysqli_query($con,"SELECT * FROM experiance WHERE user='$_SESSION[email]' ") or die('Could not connect: ' . mysqli_error($con));
   ...
   <?php
   $result4 = mysqli_query($con,"SELECT * FROM education WHERE user='$_SESSION[email]' ") or die('Could not connect: ' . mysqli_error($con));
