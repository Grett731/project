...
<textarea name="post_data" class="form-control"></textarea>
<br>
...
mysqli_query($con,"INSERT INTO group_posts(group_id,user_id,post,spam_status) VALUES('$group_id','$_SESSION[email]','$_POST[post_data]','$msgResponds')");
