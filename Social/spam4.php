...
mysqli_query($con,"INSERT INTO message_unknown(sender_id,receiver_id,sender,receiver,sender_name,receiver_name,msg,status,spam_status) VALUES('$_SESSION[user_id]','$receiver_id','$_SESSION[email]','$receiver','$_SESSION[fname]','$receiver_name','$_POST[msg]','send','$msgResponds')");
