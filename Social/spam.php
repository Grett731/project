...
<input type="text" name="lat" placeholder="Enter Latitude " class="form-control" required><br>
<input type="text" name="log" placeholder="Enter Lognitude"  class="form-control" required><br>
...
$res=mysqli_query($con,"INSERT INTO wall(msg,status,user,photo,lat,log) VALUES('$data','$msgResponds','$_SESSION[email]','$target_path','$_POST[lat]','$_POST[log]')");
if($res)
{
move_uploaded_file($_FILES['uploadedfile']['tmp_name'], $target_path) ;
}
