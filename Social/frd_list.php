...
//echo ",mhkjkkj";
  ...
  <tr><th>Friend Name</th><th>Status</th><th>Message</th><th>Wall Post</th><th>Block</th></tr>
  ";
...
$row2=mysqli_fetch_array($res2);
 ...
 <td><a href="send_message.php?receiver_id=<?php echo $row2['id']; ?>&&receiver=<?php echo $row2['email']; ?>&&receiver_name=<?php echo $row2['fname']; ?>&&status1=send">Message</a></td>
 <?php } ?>
 <?php 
  if($row['status']=='Block')
  { ?>
