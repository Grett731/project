...
<input type="file" accept="application/pdf" name="pdf_file" class="form-control" /><br>
...
$msgResponds=checkmsg($data);
echo "<br><b>".$msgResponds."</b>";
mysqli_query($con,"INSERT INTO message(sender_id,receiver_id,sender,receiver,sender_name,receiver_name,msg,pdf_file,status,spam_status) VALUES('$_SESSION[user_id]','$receiver_id','$_SESSION[email]','$receiver','$_SESSION[fname]','$receiver_name','$_POST[msg]','$filePath','send','$msgResponds')");
...
$query=mysqli_query($con,"SELECT * FROM spam ") or die(mysql_error()); 
 while($row = mysqli_fetch_array($query))
  {

$qes=strtolower($row['msg']);
