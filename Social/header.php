...
font-size:16px;
  ...
  <a href="profilepass.php" class="nav-btn" style="margin-left:20px;">Profile</a>
   
  <a href="group_list.php" class="nav-btn" style="margin-left:20px;">Group</a>
  <!--<a href="frd_list.php" class="nav-btn" style="margin-left:20px;">Friends List</a>-->
...
<br>
  ...
  <li>   <span class="glyphicon glyphicon-user"></span>   <a href="profilepass.php" class="nav-btn">Profile</a></li>
  ...
  <li>  <span class="glyphicon glyphicon-search"></span>  <a class="active nav-btn" href="skill_search.php"> Search</a></li>
