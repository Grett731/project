    ...
    -->
    	...
    	<div class="sidebar-wrapper">
            <div class="logo">
                  ...
                  <span style="font-size:20px;color:#FFF;margin-top:12px;"> Welcome <br><span style="font-size:12px;color:#000;"> <?php echo $_SESSION['user']; ?>
                </span>
                </span>
            ...
            <ul class="nav">
              ...
              <!--  <li>
                ...
                <li class="active">
                  ...
                  <li>
                   <a href="../registartion/select.php">
                        <i class="pe-7s-user"></i>
                        <p>Registration</p>
                    </a>
                </li>
